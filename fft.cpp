...
sum_info::sum_info (): raw (NULL), image (NULL), odds (NULL), evens (NULL), sample_nu (0), core_nu (0), my_nu (0)
{
}

sum_info::sum_info (std::vector <double> *r, std::vector <std::complex <double> > *i, std::vector <std::complex <double> > *o,
...
{
	const unsigned int sample_nu = proto.size ();
