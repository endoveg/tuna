...
public:
	...
	std::vector <double> *raw; //data to be analysed
	...
	sum_info ();
	sum_info (std::vector <double> *raw, std:: vector <std::complex <double> > *image, std::vector <std::complex <double> > *odds, std::vector <std::complex <double> > *evens, unsigned int sample_nu, unsigned int core_nu, unsigned int my_nu);
};

void dft (std::vector <double>& proto, std::vector <std::complex <double> > &image, const unsigned int core_nu);
